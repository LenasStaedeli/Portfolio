            ...
            <div className="bg-white rounded-4 p-4 shadow border">
                ...
                <ul className="list-unstyled mb-4" style={{ fontSize: "1.1rem" }}>
                    <li className="mb-3">
                        ...
                        <a
                            href="mailto:lenas.staedeli@outlook.com"
                            className="home-link"
                        >
                            lenas.staedeli@outlook.com
                        </a>
                    </li>
                    ...
                    <li className="mb-3">
                        ...
                        <a
                            href="https://github.com/lenasstaedeli"
                            target="_blank"
                            rel="noreferrer"
                            className="home-link"
                        >
                            github.com/lenasstaedeli
                        </a>
                    </li>
                </ul>
